  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="space-y-2"
      >
        <h2 className="text-2xl font-bold text-gray-800">Không có sản phẩm nào</h2>
        <p className="text-gray-600 max-w-md">
          ...
          . Danh mục này có thể đang tạm thời hết hàng.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="pt-2 border-t border-gray-100">
          <p className="text-xs text-gray-400 flex items-center justify-center gap-2">
            ...
            Hãy thử khám phá các danh mục sản phẩm khác của chúng tôi
          </p>
        </div>
      </motion.div>
    </div>
