      ...
      <div className="flex flex-col md:min-w-40 border rounded-lg overflow-hidden bg-white shadow-sm">
        {categories?.map((item) => (
          <Button
            ...
            className={`bg-transparent border-0 p-0 rounded-none text-dark-color shadow-none hover:bg-shop_light_green hover:text-white font-semibold transition-all duration-200 border-b last:border-b-0 capitalize ${item?.slug?.current === currentSlug &&
        ...
        {loading ? (
          ...
          <div className="w-full">
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-shop_dark_green">
                Sản phẩm thuộc{" "}
                {currentSlug ? currentSlug.replace(/-/g, " ") : "danh mục này"}
              </h3>
