            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Đọc từ Clerk (Không thể chỉnh sửa)
                </p>
              </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                <span className="text-gray-700">Điểm khách hàng thân thiết</span>
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-gray-700">Đăng nhập lần cuối</span>
        ...
        <CardContent>
          {sanity?.addresses && sanity.addresses.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mb-4">Không tìm thấy địa chỉ giao hàng</p>
