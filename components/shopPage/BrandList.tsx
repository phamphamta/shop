  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-4">
        <Title className="text-base font-semibold text-gray-900">Thương hiệu</Title>
        ...
        {brands?.map((brand) => (
          ...
          >
            ...
            <Label
              ...
              className={`flex-1 cursor-pointer transition-colors duration-150 ${selectedBrand === brand?.slug?.current
