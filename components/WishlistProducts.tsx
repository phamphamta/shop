                ...
                >
                  ...
                  >
                    <Image
                      ...
                      width={200}
                      height={200}
                      className={`w-full h-48 object-contain group-hover:scale-105 transition-transform duration-200 ${product?.stock && product.stock === 0
                        ? "opacity-50"
                        : ""
                        }`}
                    />
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-xs px-2 py-1 rounded-full font-medium ${product?.stock && product.stock > 0
