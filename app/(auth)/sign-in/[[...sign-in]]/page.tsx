  ...
  const features = [
    {
      ...
      description: "Dữ liệu của bạn được bảo vệ bằng hệ thống bảo mật cao cấp",
    },
    {
      icon: Users,
      title: "Được nhiều khách hàng tin tưởng",
      description: "Tham gia cộng đồng khách hàng hài lòng của chúng tôi",
    },
    {
      icon: Star,
      title: "Trải nghiệm cao cấp",
      description: "Nhận ưu đãi độc quyền và gợi ý mua sắm phù hợp với bạn",
    },
  ];
            ...
            <div className="max-w-md mx-auto lg:max-w-lg lg:mx-0">
              ...
              >
                ...
                <p className="text-lg text-dark-text mb-8 leading-relaxed">
                  Đăng nhập để truy cập tài khoản, theo dõi đơn hàng và tận
                  hưởng trải nghiệm mua sắm được cá nhân hóa tại{" "}
