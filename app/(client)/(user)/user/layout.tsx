...
const sidebarItems = [
  {
    ...
    description: "Xem tổng quan & số liệu",
  },
  {
    title: "Đơn hàng",
    href: "/user/orders",
    icon: Package,
    description: "Theo dõi các đơn hàng",
  },
  {
    title: "Hồ sơ cá nhân",
    href: "/user/profile",
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-2">
                      <div className="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                      <span className="text-white/90 text-xs">Đang hoạt động</span>
                    </div>
                  </div>
                </div>
              </div>
