        ...
        <Container className="max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto mb-6">
              Giải đáp nhanh các câu hỏi phổ biến nhất về ShopCart.
            </p>
          ...
          >
            <Card className="bg-gradient-to-r from-shop_light_green to-shop_dark_green text-white shadow-xl">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4">Bạn cần hỗ trợ thêm?</h3>
                <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                  Không tìm thấy câu trả lời bạn đang tìm kiếm? Hãy xem trang FAQ chi tiết của chúng tôi hoặc liên hệ với đội ngũ hỗ trợ.
                </p>
